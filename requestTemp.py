...
# for i  in range(0,len(account_dicts)):
#  try:
     
# #    print(requestTemp.get_token(account_dicts[i]["address"],account_dicts[i]["cookie_str"]))
     
#    zetaCrossChain.approveZeta(account_dicts[i]["privateKey"],account_dicts[i]["address"])
#    time.sleep(10)
#    hash_str=zetaCrossChain.testContract(account_dicts[i]["privateKey"],account_dicts[i]["address"])
#    time.sleep(10)
#    print(requestTemp.saveTransaction(hash_str,account_dicts[i]["address"],account_dicts[i]["cookie_str"]))
